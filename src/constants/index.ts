...
const experiences: TExperience[] = [
  ...
  },
  {
    ...
    date: "2024", 
    points: [
      "Developed and Implemented a Script for SEO Optimization.",
      "Creating a robust Node.Js script to identify and fill in missing meta keywords for over 7,000 web pages, significantly improving the company's search engine optimization (SEO) efforts.",
